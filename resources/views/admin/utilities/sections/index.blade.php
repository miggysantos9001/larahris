                            ...
                            <div class="body">
                                <div class="col-12">
                                    <div class="form-group">
                                        {!! Form::label('Select Grade Level') !!}
                                        {!! Form::select('',[],null,['class'=>'select2 form-control form-control-sm','placeholder'=>'-- Select One --']) !!}
                                    </div>
                                    <div class="form-group">
...
@endsection
@push('modals')
<div class="modal fade" id="edit" role="dialog" aria-hidden="true" style="display: none;">
